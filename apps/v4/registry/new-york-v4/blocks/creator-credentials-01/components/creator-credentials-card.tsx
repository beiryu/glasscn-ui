...
export function CreatorCredentialsCard({
  ...
  return (
    ...
    >
      ...
      <header className="flex items-center justify-between gap-5 self-stretch rounded-t-2xl rounded-b-none bg-gradient-to-b from-green-50 to-transparent p-4 dark:bg-gradient-to-b dark:from-[rgba(129,255,129,0.5)] dark:to-[rgba(129,255,129,0)]">
            ...
            <div className="flex items-center gap-1 text-2xl">
              ...
              >
                <Copy
                  className={cn(
                    "size-4",
                    copiedCode && "text-green-600 dark:text-green-300"
                  )}
                />
              </button>
            </div>
            ...
            <div className="flex flex-1 items-center justify-between gap-2">
              ...
              >
                <Copy
                  className={cn(
                    "size-4",
                    copiedReference && "text-green-600 dark:text-green-400"
                  )}
                />
              </button>
            </div>
