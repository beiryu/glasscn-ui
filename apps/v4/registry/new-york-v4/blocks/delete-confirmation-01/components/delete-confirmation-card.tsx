  ...
  return (
    ...
    >
      ...
      <main className="flex h-full flex-1 flex-col items-start justify-between gap-[15px] px-4 py-7">
        ...
        {/* Item Field */}
        <InputGroup className="rounded-xl border border-[rgba(245,24,28,0.5)] bg-gradient-to-b from-[rgba(245,24,28,0.1)] via-[rgba(255,255,255,0.05)] to-[rgba(245,24,28,0)] shadow-none [&_.glass]:border-0 [&_.glass]:bg-transparent [&_.glass]:shadow-none [&_.glass]:backdrop-blur-none">
          <InputGroupAddon>
